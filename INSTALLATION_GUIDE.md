# 📱 ECVP 2026 Schedule Organizer — Installation & Usage Guide
...
1. **App Opens to Search Tab**
   ...
   - Lists 618 presentations from ECVP 2026
...
- Feature list
- Data statistics
- Links to ECVP website and GitHub
...
- ⏰ **Time** — exact start and end time, anchored to Central European Summer Time (Bournemouth)
...
- Refresh the page to verify all 618 presentations are loaded
...
Questions? Open an issue on [GitHub](https://github.com/markwgreenlee/ecvp-2026-scheduler/issues) or email markwgreenlee@gmail.com.
