...
const DISMISSED_KEY = 'ecvp_install_dismissed';
const APP_URL = 'https://markwgreenlee.github.io/ecvp-2026-scheduler';
    ...
    <View style={styles.banner}>
      ...
      <View style={styles.textBlock}>
        {showIOSSteps ? (
          ...
          <>
            <Text style={styles.title}>Add ECVP 2026 to your home screen</Text>
            <Text style={styles.body}>
